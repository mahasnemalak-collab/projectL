...
<div class="bg-gradient-to-br from-blue-700 to-pink-500 min-h-screen flex flex-col justify-center items-center">
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md">
        <h1 class="text-4xl font-bold text-center text-purple-700 mb-8">Welcome to My Website</h1>
        <form  action="/parent/login" method="POST" class="space-y-6"  >
            @csrf
        <div>
            ...
            <div>
              ...
              <div>
                ...
                <input class="w-full px-4 py-2 rounded-lg border border-gray-400" id="email" name="emailchild"
                    type="email">
                @error('email')
                   {{$message}}
                @enderror
              ...
              <div>
                ...
                <input class="w-full px-4 py-2 rounded-lg border border-gray-400" id="age" name="number" type="number" placeholder="Between 3 and 12">
      ...
      <a href="/parent/signinshow" class="text-red-800 hover:text-red-600">already have a parent account?</a>
    </div>
</div>
