...
<body>
    ...
    <section class="w-full bg-purple-100">
        <div class="bg-purple-100 w-full h-[520px] bg-[url({{asset('img/main.jpg')}})] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
        <!-- Photo by '@insolitus' on Unsplash -->
            <div>
                <h1 class="text-white text-center xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl font-semibold bg-gray-800 p-2 bg-opacity-40 rounded-sm">Place for all Kids</h1>
            </div>
    ...
    @guest
        <!-- services -->
        <div class="flex flex-wrap justify-center pt-10 bg-purple-100">
            <!-- card 1 -->
            <div class="p-4 max-w-sm">
                <div class="flex rounded-lg h-full dark:bg-gray-800 bg-sky-500 hover:bg-sky-600 p-8 flex-col">
                    <div class="flex items-center mb-3">
                        <div
                            class="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full dark:bg-orange-500 bg-indigo-500 text-white flex-shrink-0">
            ...
            <!-- card 2 -->
            <div class="p-4 max-w-sm">
                <div class="flex rounded-lg h-full dark:bg-gray-800 bg-purple-500 hover:bg-purple-600 p-8 flex-col">
                    <div class="flex items-center mb-3">
                        <div
    ...
    @endguest
    @auth
        <div class="bg-purple-100 px-2 py-10">
