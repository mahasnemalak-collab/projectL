...
<body class="bg-gray-100">
  ...
  <!-- Quiz Container -->
  <div class="flex items-center justify-center min-h-screen bg-[url('{{ asset('img/Translation_intermidate.jpg') }}')] bg-cover bg-center">
    <div class="w-1/2 p-8 bg-white shadow-lg rounded-lg text-center">
      ...
      <!-- Quiz Form -->
      <form id="quizForm" action="/test/translation/Translation_intermidate/post" method="POST" onsubmit="return checkAnswer()">
        @csrf
  ...
  <script>
    const questions = [
            {
                word: "Red apple",
                options: ["تفاح أحمر", "برتقالة صفراء", "موز أصفر", "ليمون أخضر"],
                correct: "تفاح أحمر"
            },
            {
                word: "Sweet orange",
                options: ["برتقالة حلوة", "تفاحة خضراء", "موزة ناضجة", "عنب أحمر"],
                correct: "برتقالة حلوة"
            },
            {
                word: "Fresh lemon",
                options: ["ليمون طازج", "تفاح قديم", "مشمش ناضج", "خوخ طازج"],
                correct: "ليمون طازج"
            },
            {
                word: "Green cucumber",
                options: ["خيار أخضر", "فلفل أحمر", "كوسة صفراء", "بطاطس بيضاء"],
                correct: "خيار أخضر"
            },
            {
                word: "Ripe banana",
                options: ["موز ناضج", "تفاح أخضر", "خوخ ناضج", "تين طازج"],
                correct: "موز ناضج"
            }
    ];
