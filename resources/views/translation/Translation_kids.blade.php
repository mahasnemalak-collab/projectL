...
<body class="bg-gray-100">
  ...
  <!-- Quiz Container -->
  <div class="flex items-center justify-center min-h-screen bg-[url('{{ asset('img/Translation_kids.jpg') }}')] bg-cover bg-center">
    <div class="w-1/2 p-8 bg-white shadow-lg rounded-lg text-center">
      ...
      <!-- Quiz Form -->
      <form id="quizForm" action="/test/translation/Translation_kids/post" method="POST" onsubmit="return checkAnswer()">
        @csrf
  ...
  <script>
    const questions = [
      {
        word: "Apple",
        options: ["برتقال", "تفاح", "ليمون", "اجاص"],
        correct: "تفاح"
      },
      {
        word: "Banana",
        options: ["موز", "أناناس", "تفاح", "خوخ"],
        correct: "موز"
      },
      {
        word: "Lemon",
        options: ["ليمون", "تفاح", "كمثرى", "عنب"],
        correct: "ليمون"
      }
    ];
