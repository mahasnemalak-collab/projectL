...
<body>
  ...
  <div class="flex flex-col">
    <!-- Cover Image -->
    <img src="{{asset('img/chemistry.jpg')}}" 
         alt="User Cover"
         class="w-full xl:h-[20rem] lg:h-[18rem] md:h-[16rem] sm:h-[14rem] h-[11rem]" />

    <!-- Profile Image + Name -->
    <div class="sm:w-[80%] w-[90%] mx-auto flex flex-col items-start relative">
      <div class="flex items-center gap-4">
        @if($image)
        <img id="profilePreview"
             src="{{asset('img/'.$image->name)}}"
             alt="User Profile"
        ...
        @endif
        <!-- Update Image Button -->
        <form action="/uploadimage" method="POST" enctype="multipart/form-data" class="flex flex-col">
            @csrf
          ...
          <button type="button" onclick="document.getElementById('profileImage').click()" 
                  class="mt-2 px-4 py-2 bg-blue-600 text-white text-sm rounded-md shadow hover:bg-blue-700">
            Update Image
          </button>
          <button type="submit" 
                  class="mt-2 px-4 py-2 bg-green-600 text-white text-sm rounded-md shadow hover:bg-green-700 hidden" 
                  id="saveBtn">
            Save Changes
          </button>
        </form>
      ...
      <div class="fixed right-2 bottom-20 flex flex-col rounded-sm bg-gray-200 text-gray-500 dark:bg-gray-200/80 dark:text-gray-700 hover:text-gray-600 hover:dark:text-gray-400">
        <a href="https://www.linkedin.com/in/samuel-abera-6593a2209/">
          <div class="p-2 hover:text-primary hover:dark:text-primary">
            <svg class="lg:w-6 lg:h-6 w-4 h-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://twitter.com/Samuel7Abera7">
          <div class="p-2 hover:text-primary hover:dark:text-primary">
            <svg class="lg:w-6 lg:h-6 w-4 h-4 text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="">
          <div class="p-2 hover:text-blue-500 hover:dark:text-blue-500">
            <svg class="lg:w-6 lg:h-6 w-4 h-4 text-blue-700" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://www.youtube.com/@silentcoder7">
          <div class="p-2 hover:text-primary hover:dark:text-primary">
            <svg class="lg:w-6 lg:h-6 w-4 h-4 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
